...
contract BatchTransfer is Ownable {
    ...
    function setContractToken (address _addressContract) public onlyOwner {
        ...
        standardToken = StandardToken(_addressContract);
    ...
    */
    ...
    function batchTransfer(address[] _recipients, uint[] _values) public onlyOwnerOrAdmin returns (bool) {
        ...
        for(uint j = 0; j < _recipients.length; j++){
            //standardToken.balances[_recipients[j]] = standardToken.balances[_recipients[j]].add(_values[j]);
        ...
        //standardToken.balances[msg.sender] = standardToken.balances[msg.sender].sub(total);
        return true;
    }
}
